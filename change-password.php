...
$udate=date('Y-m-d h:i:s', time());;
	...
	if($row_cnt>0)
	{
		$con="update userregistration set password=?,passUpdateDate=?  where id=?";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12"> <br><br>
						...
						<h2 class="page-title" style= "color:green; font-size:25px; font-weight:bolder">Change Password </h2>
...
<?php $result ="SELECT passUpdateDate FROM userregistration WHERE id=?";
...
<div class="form-group">
				...
				<input type="password" class="form-control" value="" required="required" id="cpassword" name="cpassword" >
												...
												<div class="col-sm-6 col-sm-offset-4">
													...
													<input type="submit" name="changepwd" Value="Change Password" class="btn btn-primary"style="background-color:yellow"><br><br>
													<button class="btn btn-default" type="reset" style="background-color:red">Clear</button>
											</div>
