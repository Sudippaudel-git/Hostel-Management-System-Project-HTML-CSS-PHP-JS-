					...
					<div class="col-md-12"><br><br>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%" border="1">
									<thead>
										<tr>
											<th>Sno.</th>
...
<td><a href="edit-room.php?id=<?php echo $row->id;?>"><i >&#9998;</i></a>&nbsp;&nbsp;
<a href="manage-rooms.php?del=<?php echo $row->id;?>" onclick="return confirm("Do you want to delete");"><i >&#10008;</i></a></td>
										</tr>
									<?php
$cnt=$cnt+1;
									 } ?>
